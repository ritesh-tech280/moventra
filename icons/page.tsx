...
export function LogoIcon({ size = 32, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path
        d="M10 28V12L17 21L20 16L24 23L30 12V28"
        stroke="#3B82F6"
        strokeWidth="2.75"
        strokeLinecap="round"
...
export function SuvIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M3 13h18l-1.5-5.5a2 2 0 0 0-1.9-1.5H6.4a2 2 0 0 0-1.9 1.5L3 13z" />
      <path d="M3 13v4a1 1 0 0 0 1 1h1" />
      <path d="M19 18h1a1 1 0 0 0 1-1v-4" />
...
export function NavigationIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DollarSignIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function HeadphonesIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LuggageIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function AppleIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 6.37c.61-.75 1.04-1.8 0.92-2.85-.92.04-2.08.62-2.72 1.37-.57.65-1.06 1.71-.93 2.73 1.04.08 2.12-.5 2.73-1.25z" />
    </svg>
  );
}

export function GooglePlayIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M3.609 1.814L13.793 12 3.61 22.186A2.21 2.21 0 0 1 3 20.61V3.39c0-.6.223-1.168.609-1.576zm11.242 11.244l2.585 2.585-11.455 6.613 8.87-9.198zm0-2.116L5.981 1.744l11.455 6.613-2.585 2.585zm1.488 1.059l3.39-1.957a1.69 1.69 0 0 1 0 2.932l-3.39 1.957-1.026-1.026 1.026-.906z" />
    </svg>
  );
}
...
export function LinkedinIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.46 8.76a1.69 1.69 0 0 0 1.69-1.68c0-.93-.76-1.69-1.69-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .92.76 1.68 1.69 1.68m1.39 9.74v-8.37H5.07v8.37h2.78z" />
    </svg>
  );
}
